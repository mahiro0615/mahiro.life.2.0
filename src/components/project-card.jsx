      ...
      >
        <div
          className={classNames(
            "relative w-full h-96 max-w-sm transition-transform duration-500 transform-style-preserve-3d mx-auto",
        ...
        >
         ...
         <div className="absolute w-full h-full rounded-3xl shadow-2xl transform rotateY-180 backface-hidden flex flex-col">
            <div className="relative w-full h-1/2 overflow-hidden rounded-t-3xl">
              <Image src={getStatusBackgroundImage(project.meta.status)} alt="Project Poster" layout="fill" objectFit="cover" className="rounded-t-3xl" />
